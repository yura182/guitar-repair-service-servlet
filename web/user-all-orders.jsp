                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="details-link" href="${pageContext.request.contextPath}/user-order-details?command=userOrderDetails&orderId=${order.id}&userId=${order.client.id}"><fmt:message key="user.orders.details"/></a>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
